...
require (
	golang.conradwood.net/apis/antidos v1.1.2297
	golang.conradwood.net/apis/auth v1.1.2309
	golang.conradwood.net/apis/common v1.1.2309
	golang.conradwood.net/apis/email v1.1.2297
	golang.conradwood.net/apis/h2gproxy v1.1.2297
	golang.conradwood.net/apis/objectstore v1.1.2309
	golang.conradwood.net/apis/slackgateway v1.1.2297
	golang.conradwood.net/apis/themes v1.1.2297
	golang.conradwood.net/apis/weblogin v1.1.1428
	golang.conradwood.net/go-easyops v0.1.18120
	golang.yacloud.eu/apis/sessionmanager v1.1.2297
