...
require (
	golang.conradwood.net/apis/antidos v1.1.2125
	golang.conradwood.net/apis/auth v1.1.2125
	golang.conradwood.net/apis/common v1.1.2125
	golang.conradwood.net/apis/email v1.1.2125
	golang.conradwood.net/apis/h2gproxy v1.1.2125
	golang.conradwood.net/apis/objectstore v1.1.2125
	...
	golang.conradwood.net/go-easyops v0.1.15763
